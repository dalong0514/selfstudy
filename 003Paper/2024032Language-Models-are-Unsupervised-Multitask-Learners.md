...
The current best performing systems on language tasks are large neural networks trained on a single language modeling objective on large text corpuses. These systems are able to generate samples of text of unprecedented quality and are able to do so at a scale beyond what was previously possible. This work aims to push these systems towards performing a wide variety of language tasks in a more general setting.
