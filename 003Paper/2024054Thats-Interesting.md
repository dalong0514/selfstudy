...
「现象学」这个概念还有一个更宽泛的含义 —— 这是由 Hegel 和 Husserl 发展出来的 —— 它不仅包含那些具有迷惑性的虚假表象和假设，还包括思维从这些表象和假设向本质真理迈进的整个过程。正是基于这种涵盖整个过程的更广泛意义，我在这些篇章中试图勾勒出一个社会学的现象学研究。
...
我认为，所有被认为有趣的社会理论都会引发其受众思维方式的某种转变。这些理论首先暗中道出了那些认为它们有趣的受众所习以为常的假设，然后以某种更高层次或更根本的真理为名否定这些假设。有趣的是，社会学不仅建立在这种现象学过程之上，这种现象学过程本身也是建立在社会学基础之上的，因为不同受众群体的假设 —— 即这个过程的起点 —— 在社会空间中呈现出不同的分布特征。因此，要想充分发展「有趣社会学」这一研究领域，就必须将两个方面结合起来：一是研究受众思维如何从一种社会理论转向另一种理论的「社会学现象学」，二是研究信念分布和假设转变的「现象学社会学」。诚然，知识社会学研究了意识形态的历史演变，但至少在其经典形态中（Mannheim，1936），它把信仰系统视为静态现象，将其历史演变视为一种静态意识形态被另一种静态意识形态突然替代的过程。相比之下，有趣社会学具有更强的动态性。它关注的是一个信仰系统转变为另一个信仰系统的关键时刻，特别是当旧理论假设对某些个人或群体的影响开始减弱，以至于他们开始对新的、甚至与旧理论相矛盾的理论产生兴趣的那个时刻。它致力于发现这种变革背后精确的社会学和现象学机制。这并不是说知识社会学应该被有趣社会学取代，而是说知识社会学需要有趣社会学的补充，因为某些在知识社会学视角下难以看清的理论结构变化，在有趣社会学的视角下可能会更加清晰。
...
上述关于「有趣」的讨论为我们提供了一个与 Thomas Kuhn（1962）完全不同的科学革命模型。Kuhn 的基本观点是，当科学家遇到与现有科学假设和解释程序（即「范式」（Paradigm））不相符的异常经验时，他们会寻找能更好解释这些异常现象的新范式。但是，如果认为大多数科学家都要等到具体异常现象迫使他们才愿意改变已接受的概念框架，这就是把保守主义和缺乏进取心这样的性格特征强加给了大多数科学家，这种性格特征即便在自然科学家中也不会那么普遍，更不用说社会科学家了。与 Kuhn 的观点相反，我认为，对陈旧范式的厌倦感和建立学术声誉的渴望才是驱使许多科学家主动寻找新异常现象的动力。他们希望找到那些旧范式无法解释，但新范式（最好是他们自己提出的）可以解释的现象，而不是被动地等待异常现象的出现。在学术界，将自己的声誉与一个新兴的范式绑定，比守着一个日渐衰落的旧范式更容易获得专业地位。在学术领域获得声誉的最佳方式就是提出有趣的观点 —— 否定常规假设，确认意外发现。
...
然而这其中需要把握分寸。在令人惊喜和令人震惊之间，在有趣和荒谬之间存在着一条微妙但清晰的界限。如前所述，一个有趣的命题是否定受众轻度持有的假设。但如果有人试图否定受众强烈持有的假设，他们的理智就会受到质疑。他们会被当作疯子；如果是科学家，就会被贴上「怪人」的标签。如果说受到启发的天才与疯子的区别仅在于他们所挑战的受众假设的根深蒂固程度，那么人们常说天才与疯狂一线之隔，或许就是这个道理。
...
在这篇文章中，我试图提出一种分析理论命题的新方法。我认为，理解为什么某个受众会觉得一个理论有趣，与确认其内容的真实性或形式逻辑同样重要。
...
因此，这篇文章既是描述性的，也是劝诫性的。就描述性而言，我试图指出是什么因素使伟大理论家的著作如此引人入胜；就劝诫性而言，我希望读者能更多地关注这些因素，从而使自己的写作更具吸引力。我主张，「创造」有趣理论应该得到与「验证」平淡理论同等的重视。本研究应被视为对那个将伟大理论家与平庸者区分开来的「天才」特质的初步探索。
