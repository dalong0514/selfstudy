...
But by far the most prodigious investments in R&D flowed from the War Department (dollar 800 million) and the Navy Department (dollar 400 million). The largest portion of that went to private industry ($800 million), much of it directed towards emergent industries with compelling national-security interests — for example, aerospace, electronics, computing and nuclear technology8.
