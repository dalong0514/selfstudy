...
For example, suppose class T' has operations o1 and o. And instance variable v. And class S, which is declared to be a subclass of T, has operations o, and3 and instance variable v 2· Then the le result in Smalltalk is effectively a class with two instance variables, v, and v, and three operations, where the code of o is supplied by T, and the code of the other two operations is supplied by S. It is this combined code that must be understood, or modified if S is reimplemented, unless is restricted as discussed further below.
