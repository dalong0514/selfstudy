...
### 1.2.1 Performing a GET request
...
### 1.2.2 Performing a POST request
...
### 1.2.3 Performing multiple concurrent requests
...
### 1.6.2 Custom instance defaults
...
### 1.6.3 Config order of precedence
...
## 1.10 Using application/x-www-form-urlencoded format
